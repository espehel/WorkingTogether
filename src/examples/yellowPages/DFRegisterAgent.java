...
/**
   This example shows how to initiate an application specific service in the Yellow Pages
   catalogue managed by the DF Agent so that other agents can dynamically discover it.
   In this case in particular we initiate a "Weather-forecast" service for
...
public class DFRegisterAgent extends Agent {
  ...
  protected void setup() {
  	...
  	// Read the name of the service to initiate as an argument
